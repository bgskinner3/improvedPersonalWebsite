      ...
      <div className="w-full  h-screen flex justify-center items-center">
        <div className="relative z-0">
          <img
            src={pic3}
            alt=""
            className="w-screen object-cover opacity-40 h-screen"
          />
                  ...
                  >
                    ...
                    <div className="mb-2">
                      <div className=" relative ">
                        <input
                          id="username"
                          className="rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-neutral-content focus:border-transparent"
                          type="username"
